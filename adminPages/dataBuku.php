    ...
    <div class="sidebar">
      ...
      <div class="sidebar-menu">
        <ul>
          ...
          <li>
            <a href="#" class="active"><i class="bi bi-bookshelf"></i><span>Data buku</span></a>
          </li>
          <li>
                  ...
                  <table class="table table-hover" id="dt" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= $book['id_buku'] ?></td>
                        <td><?= $book['judul'] ?></td>
                        <td><img src="img/<?= $book['foto'] ?>" alt="ehe" width="100"></td>
                        <td><?= $book['nama_penulis'] ?></td>
                        <td><?= $book['status'] ?></td>
                        <td>
                          <div class="action">
                            <button>
                              <a href="../config/editBuku.php?id=<?= $book['id'] ?>"><i class="bi bi-pencil"></i></a>
                            </button>
                            <button onclick="return confirm('Apakah anda ingin menghapus buku?');">
                              <a href="../config/hapusBuku.php?id=<?= $book['id'] ?>"><i class="bi bi-trash"></i></a>
                            </button>
                          </div>
                        </td>
                        <?php $i++; ?>
